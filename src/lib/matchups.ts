...
/**
 * The selected hero's notable matchups: each enemy's whole-game win rate vs this hero, minus the
 * hero's own baseline. Enemies well below baseline counter you (build against them); well above,
 * you're favoured.
 */
